...
class BangBangTrajectory2D(Trajectory):
    ...
    def generate(self, initial_pos: Vec2, final_pos: Vec2, initial_vel: Vec2, max_vel: float, max_acc: float,
        ...
        if target_time is None or target_time < 0:
            ...
            self.generate_shortest_timed2(initial_pos, final_pos, initial_vel, max_vel, max_acc, accuracy, target_time)
    ...
    def generate_shortest_timed2(self, initial_pos: Vec2, final_pos: Vec2, initial_vel: Vec2, max_vel: float,
        ...
        while inc > 1e-7:
            ...
            self.x.generate(s0x, s1x, v0x, max_vel * cos_alpha, max_acc * cos_alpha, target_time)
            self.y.generate(s0y, s1y, v0y, max_vel * sin_alpha, max_acc * sin_alpha, target_time)
